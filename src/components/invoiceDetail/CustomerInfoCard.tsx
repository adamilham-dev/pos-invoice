...
const CustomerInfoCard = () => (
  <Card className="p-5 mx-4 md:mx-6">
    ...
    <div className="flex flex-col gap-1 body-small-reguler text-neutral-80">
      <div className="grid grid-cols-1 sm:grid-cols-12">
        <p className="sm:col-span-4">Nama Customer / Perusahaan</p>
        <p className="text-nowrap">PT BCA FINANCE (BPKB)</p>
      </div>
      <div className="grid grid-cols-1 sm:grid-cols-12">
        <p className="sm:col-span-4">No. Telepon</p>
        <p className="text-nowrap">(62) 81234567890</p>
      </div>
      <div className="grid grid-cols-1 sm:grid-cols-12">
        <p className="sm:col-span-4">Email</p>
        <p className="text-nowrap">bcafinance@gmail.com</p>
      </div>
      <div className="grid grid-cols-1 sm:grid-cols-12">
        <p className="sm:col-span-4">Alamat Billing</p>

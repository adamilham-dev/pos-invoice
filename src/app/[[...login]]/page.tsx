...
const LoginPage = () => {
  ...
  return (
    <div className="w-full min-h-screen grid grid-cols-1 lg:grid-cols-2 items-center justify-center">
      <div className="bg-neutral-10 w-full h-full flex items-center justify-center p-4 sm:p-6 lg:p-0">
        <div className="w-full lg:w-2/3 h-full mx-auto flex flex-col gap-6 justify-center">
      ...
      <div className="hidden lg:block relative bg-[url(/assets/bg-login.png)] w-full h-full bg-cover bg-no-repeat">
        <div
          className="absolute top-0 left-0 w-full h-full bg-linear-to-r from-[#131347] from-20% 
